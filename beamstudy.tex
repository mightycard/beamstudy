...
\begin{figure*}[!tbp]
  \subfigure[Synergia Tracking Results]{
    \includegraphics[width=.45\textwidth]{img/fig_beamloss1a}
    \label{fig:beamloss11}}
  \subfigure[RK4 Tracking Results]{
    \includegraphics[width=.45\textwidth]{img/fig_beamloss1b}
    \label{fig:beamloss12}}
