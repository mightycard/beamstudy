...
The Kobayashi Hamiltonian describes motions of particles in the phase space coordinates for every three turn.
...
%More detailed discussions about the Kobayashi Hamiltonian can be found in references~\cite{pullia}.
...
Using the simpified resonance model described above and Synergia, we perform and compare results of particle tracking simulations which will be shown in next subsections. We measure arrival time of particles streaming to the septum plane, and we track particles which are scattered by septum foils.

\subsection{\label{sec:arrival}Arrival Time Profile}

For the resonant extraction scheme, one of the most important part is to achieve stable spills during the entire extraction. However, it is quite possible to have unwanted spill fluctuations in the presence of magnet power supply ripples. Moreover, the RFKO feedback system to regulate the spill rate for the Mu2e experiment requires precise predictions of those fluctuations. 
