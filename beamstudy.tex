...
\begin{figure*}[!tbp]
  ...
  \subfigure[After applying dynamic bumps]{
    ...
    \label{fig:bump5b}}
  \caption{\label{fig:bump5}Particle losses in time with and without dynamic bumps.}
\end{figure*}
...
\begin{figure*}[!tbp]
  \subfigure[Emittance Growth Rates]{
    \includegraphics[width=.45\textwidth]{img/fig_rfko1a}
    \label{fig:rfko1a}}
  \subfigure[Motions of Beam Centers]{
